...
<body class="antialiased">
    <div
        ...
        <div class="max-w-7xl mx-auto ">
            ...
            <div class="flex justify-center">
                <h2 class="mt-6 text-xl font-semibold text-gray-900">Biblioteca iTech Select</h2>
            </div>
                    ...
                    <div
                        ...
                        <div>
                            <p class="mt-2 text-gray-500 text-sm leading-relaxed">
                                La aplicacion permite la reserva y devolución de libros de la bliblioteca.
                                Los clientes serán los que reserven y devuelvan los libros, dentro de un plazo
                                permitido.
                            </p>
                            <p class="mt-2 text-gray-500 text-sm leading-relaxed">
                                Se establece un plazo de reserva de 48 horas a contar desde el día siguiente a cuando se
                                ha hecho la reserva.
                                Por ejemplo, si se reserva un libro el 24 de agosto, el libro deberá ser devuelto como
                                máximo el 26 de agosto a las 23:59:59
                            </p>
                        </div>
                    </div>
                </div>
