<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-2">
                <x-label for="doc_id" value="{{ __('Documento de identidad') }}" />
                <x-input id="doc_id" class="block mt-1 w-full" type="text" name="doc_id" :value="old('doc_id')" required autofocus autocomplete="doc_id" />
            </div>
